<footer class="mt-5 mb-3 footer-custom">
    <div class="container-fluid">
            ...
            <div class="col-3">
                ...
                <div class="row pt-5">
                    <div class="col-3 d-flex justify-content-center align-items-center">
                        <i class="bi bi-github fs-3 footer-custom-icon"></i>
                    </div>
                    <div class="col-3 d-flex justify-content-center align-items-center">

                    </div>
                    <div class="col-3 d-flex justify-content-center align-items-center">
                        <i class="bi bi-youtube fs-3 footer-custom-icon"></i>
                    </div>
                    <div class="col-3 d-flex justify-content-center align-items-center">
                        <i class="bi bi-discord fs-3 footer-custom-icon"></i>
                    </div>
                </div>
            </div>
            <div class="col-9">
                <div class="row">
                    <div class="col-3">
                        ...
                        <ul class="list-unstyled">
                            <li class="pt-4 footer-custom-li">Documentation</li>
                            <li class="pt-4 footer-custom-li">Starter kits</li>
                            <li class="pt-4 footer-custom-li">Release Notes</li>
                            <li class="pt-4 footer-custom-li">Blog</li>
                            <li class="pt-4 footer-custom-li">News</li>
                            <li class="pt-4 footer-custom-li">Community</li>
                            <li class="pt-4 footer-custom-li">Larabelles</li>
                            <li class="pt-4 footer-custom-li">Learn</li>
                            <li class="pt-4 footer-custom-li">Jobs</li>
                            <li class="pt-4 footer-custom-li">Career</li>
                            <li class="pt-4 footer-custom-li">Trust</li>
                        </ul>
                    </div>
                    <div class="col-3">
                        <div class="fw-bold">
                        ...
                        <ul class="list-unstyled">
                            <li class="pt-4 footer-custom-li">Cloud</li>
                            <li class="pt-4 footer-custom-li">Forge</li>
                            <li class="pt-4 footer-custom-li">Nigthwatch</li>
                            <li class="pt-4 footer-custom-li">Vapor</li>
                            <li class="pt-4 footer-custom-li">Nova</li>
                        </ul>
                    </div>
                    <div class="col-3">
                        <div class="fw-bold">
                        ...
                        <ul class="list-unstyled">
                            <li class="pt-4 footer-custom-li">Cashier</li>
                            <li class="pt-4 footer-custom-li">Dusk</li>
                            <li class="pt-4 footer-custom-li">Horizon</li>
                            <li class="pt-4 footer-custom-li">Octane</li>
                            <li class="pt-4 footer-custom-li">Scout</li>
                            <li class="pt-4 footer-custom-li">Pennant</li>
                            <li class="pt-4 footer-custom-li">Pint</li>
                            <li class="pt-4 footer-custom-li">Sail</li>
                            <li class="pt-4 footer-custom-li">Sanctum</li>
                            <li class="pt-4 footer-custom-li">Socialite</li>
                            <li class="pt-4 footer-custom-li">Telescope</li>
                            <li class="pt-4 footer-custom-li">Pulse</li>
                            <li class="pt-4 footer-custom-li">Reverb</li>
                            <li class="pt-4 footer-custom-li">Echo</li>
                        </ul>
                    </div>
                    <div class="col-3">
                        <div class="fw-bold">
                            Partners
                            <ul class="list-unstyled">
                                <li class="pt-4 footer-custom-li">Redberry</li>
                                <li class="pt-4 footer-custom-li">64 Robots</li>
                                <li class="pt-4 footer-custom-li">Curotec</li>
                                <li class="pt-4 footer-custom-li">Kirschbaum</li>
                                <li class="pt-4 footer-custom-li">DevSquad</li>
                                <li class="pt-4 footer-custom-li">Tighten</li>
                                <li class="pt-4 footer-custom-li">Vehikl</li>
                                <li class="pt-4 footer-custom-li">Active Logic</li>
                                <li class="pt-4 footer-custom-li">More Partners</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-span-12 custom-footer-svg">
                <svg class="w-full h-full text-laravel-red" width="1280" height="308" viewBox="0 0 1280 308" fill="none" xmlns="http://www.w3.org/2000/svg">
